...
public struct Validate {
    ...
    static public func validateUsername(_ username: String) -> Bool {
    ...
    static public func validateName(_ name: String) -> Bool {
    ...
    static public func validateSex(_ sex: String) -> Bool {
        return sex != "" && sex != "blank"
    }
    
    static public func validateEmail(_ email: String) -> Bool {
